...
public class AdddetailsControllerOut implements Initializable {
    ...
    public void populateorderdetailstable() {
        ...
        try {
            ...
            String query = "SELECT * from orderdetails where orderid = (SELECT MAX(orderid) AS highest FROM orders)";
    ...
    public void addItemtoOrder() {
        try {
            ...
            String query = "SELECT orderid FROM orders WHERE orderid = (SELECT MAX(orderid) AS highest FROM orders)";
